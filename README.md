...
| `platform/` | 플랫폼팀 | Gitea + Harbor 설치/설정/매니페스트 (폐쇄망 내부 Git + 레지스트리) |
| `apps/` | 앱팀 | 데모 시나리오 샘플 앱 + Gitea Actions 파이프라인 (v1→v2 push 루프) |
...
clcoco/
├── airgap/      [인프라] 아래 상세
├── platform/    [플랫폼팀] Gitea / Harbor  — platform/README.md
└── apps/        [앱팀]     데모 샘플 앱    — apps/README.md
```
